...
class TestSignalSlot:
    ...
    class C2(EventLoopObject):
        ...
        def on_reply(self, p, x):
            log.debug('reply from %s(%d) received by %s %s', p, x, self.object_id,
                      process_name(self.event_loop.process))
    ...
    def test_basic(self):
        ...
        o1 = self.C1(event_loop, 'o1')
        o2 = self.C2(event_loop, 'o2')
        ...
        o3 = self.C1(p.event_loop, 'o3_p')
        o4 = self.C2(p.event_loop, 'o4_p')
        ...
        o5 = self.C1(p2.event_loop, 'o5_p2')
        o6 = self.C2(p2.event_loop, 'o6_p2')
        ...
        o7 = self.C1(p2.event_loop, 'o7_p2')
        o8 = self.C2(p2.event_loop, 'o8_p2')
    ...
    def test_multiarg(self):
        ...
        o1 = self.C3(p.event_loop, 'o1')
        o2 = self.C4(p.event_loop, 'o2')
    ...
    def test_same_object_name(self):
        event_loop = EventLoop('main_loop')
