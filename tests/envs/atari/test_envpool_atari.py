...
from sf_examples.envpool_examples.atari_examples.train_envpool_atari import parse_atari_args
...
class TestEnvpoolAtariEnv:
    ...
    def register_atari_fixture(self):
        from sf_examples.envpool_examples.atari_examples.train_envpool_atari import register_atari_components
    ...
    def make_env(env_config):
        from sf_examples.envpool_examples.atari_examples.atari.envpool_atari_utils import make_atari_env
