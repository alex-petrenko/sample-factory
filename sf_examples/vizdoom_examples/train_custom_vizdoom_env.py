...
To train:
python -m sf_examples.train_custom_vizdoom_env --algo=APPO --env=doom_my_custom_env --experiment=example --save_every_sec=5 --experiment_summaries_interval=10

After training for a desired period of time, evaluate the policy by running:
python -m sf_examples.enjoy_custom_vizdoom_env --algo=APPO --env=doom_my_custom_env --experiment=example
...
from sf_examples.vizdoom_examples.doom import doom_action_space_extended
from sf_examples.vizdoom_examples.doom.doom_utils import DoomSpec, register_additional_doom_env
