...
def make_doom_env_impl(
    ...
    **kwargs,
    ...
    if player_id is None:
        ...
        from sf_examples.vizdoom_examples.doom.multiplayer.doom_multiagent import VizdoomEnvMultiplayer
...
def make_doom_multiplayer_env(doom_spec, cfg=None, env_config=None, **kwargs):
    ...
    if is_multiagent:
        ...
        from sf_examples.vizdoom_examples.doom.multiplayer.doom_multiagent_wrapper import MultiAgentEnv
        ...
        from sf_examples.vizdoom_examples.doom.multiplayer.doom_multiagent_wrapper import init_multiplayer_env
