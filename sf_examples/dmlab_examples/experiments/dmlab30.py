...
# Run locally: python -m sample_factory.runner.run --runner=processes --max_parallel=2 --experiments_per_gpu=2 --num_gpus=1 --run=sf_examples.dmlab_examples.experiments.dmlab30
