...
SMALL_MODEL_CLI = QUAD_BASELINE_CLI + (
    ...
    '--quads_neighbor_encoder_type=no_encoder --with_wandb=True'
)
...
# python -m sample_factory.runner.run --run=sample_factory_examples.swarm_rl_examples.runs.single_drone --runner=processes --max_parallel=4 --pause_between=1 --experiments_per_gpu=1 --num_gpus=1