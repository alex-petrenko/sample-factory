...
vstr = "hipposlam_search2"

cli = (
    "--env=openfield_map2_fixed_loc3 "
    "--wandb_project=SF_dmlab_NEMO_tech_n_worker "
    "--seed=42 "
    "--train_for_seconds=86400 "
    "--algo=APPO "
    "--gamma=0.99 "
    "--use_rnn=True "
    "--num_workers=32 "
...
# python -m sample_factory.launcher.run --backend=slurm --slurm_workdir=./slurm_grid --slurm_gpus_per_job=0 --slurm_cpus_per_gpu=40 --slurm_sbatch_template=./training_template.sh --pause_between=1 --slurm_print_only=False --run=sf_examples.dmlab.experiments.Hipposlam_batch_run --slurm_partition=genoa --slurm_timeout=24:05:00