...
QUAD_BASELINE_CLI = (
    'python -m sample_factory_examples.swarm_rl_examples.train_swarm_rl --env=quadrotor_multi --train_for_env_steps=1000000000 --algo=APPO --use_rnn=False '
    '--num_workers=8 --num_envs_per_worker=16 --learning_rate=0.0001 --ppo_clip_value=5.0 --recurrence=1 '
...
QUAD_BASELINE_CLI_8 = (
    'python -m sample_factory_examples.swarm_rl_examples.train_swarm_rl --env=quadrotor_multi --train_for_env_steps=2000000000 --algo=APPO --use_rnn=False '
...
QUAD_BASELINE_SCALE_CLI_48 = (
    'python -m sample_factory_examples.swarm_rl_examples.train_swarm_rl --env=quadrotor_multi --train_for_env_steps=2100000000 --algo=APPO --use_rnn=False '
