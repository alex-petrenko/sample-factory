...
RUN_DESCRIPTION = RunDescription('doom_bots_v39_fs2_stopping_v2', experiments=[_experiment], pause_between_experiments=10, use_gpus=6, experiments_per_gpu=2, max_parallel=12)
