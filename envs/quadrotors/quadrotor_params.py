...
def add_quadrotors_env_args(env, parser):
    ...
    p.add_argument('--quads_collision_reward', default=None, type=float, help='Override default value for quadcol_bin reward, which means collisions between quadrotors')
    p.add_argument('--quads_collision_obstacle_reward', default=None, type=float, help='Override default value for quadcol_bin_obst reward, which means collisions between quadrotor and obstacle')
    ...
    p.add_argument('--quads_mode', default='sanity_check', type=str, choices=['static_goal', 'dynamic_goal', 'circular_config', 'lissajous3D'], help='Choose which scenario to run')
