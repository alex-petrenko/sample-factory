...
def add_quadrotors_env_args(env, parser):
    ...
    p.add_argument('--quads_obs_space_type', default='origin', type=str, choices=['origin', 'histogram', 'mean_embed'], help='The type of observation space of quadrotor. origin: same as single quad, not include any info about other drones; histogram: use relative distance and bearing of other drones, and use histogram to deal with them; mean_embed: drones receive relative pos and relative vel info from all other drones')
