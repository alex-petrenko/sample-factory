...
def add_quadrotors_env_args(env, parser):
    ...
    p.add_argument('--obs_space', default='default', type=str, choices=['default', 'extend', 'extend+'], help='Choose what kind of obs to send to encoder. Extend = rel. pos/vel. Extend+ = rel. pos.vel and goal pos')
